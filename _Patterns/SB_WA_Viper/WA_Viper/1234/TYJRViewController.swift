...
class TYJRViewController: UIViewController, TYJRViewProtocol, TYJRViewLogicProtocol {
    
    //MARK: - Configure
    var presenter: (TYJRPresenterLogicProtocol & TYJRDataStoreProtocol)?
    var configurator = TYJRConfigurator()
    ...
    deinit { print("===== DEINITED: TYJRViewController") }
...
extension TYJRViewController: UITableViewDelegate, UITableViewDataSource {
