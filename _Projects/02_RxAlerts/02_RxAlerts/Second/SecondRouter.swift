...
//    }
    ...
    //MARK: - Navigation
    private func navigateTo(source: SecondViewController, destination: UIViewController) {
        //Navigation Forward
...
//    private func passDataTo(source: SecondDataStore, destination: inout DestinationDataStore) {
//        destination.dataStore = source.dataStore
//    }
//
//    //Pass Data in Modal with Delegate
//    private func passDataTo(source: SecondDataStore) {
