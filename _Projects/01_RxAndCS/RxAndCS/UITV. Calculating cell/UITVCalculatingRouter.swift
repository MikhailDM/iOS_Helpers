...
protocol UITVCalculatingRoutingLogic {
    func routeTo()
}
...
protocol UITVCalculatingDataPassing {
    var dataStore: UITVCalculatingDataStore? { get set }
}


class UITVCalculatingRouter: NSObject, UITVCalculatingRoutingLogic, UITVCalculatingDataPassing {
    //MARK: - Properties
    
    weak var viewController: UITVCalculatingViewController?
    var dataStore: UITVCalculatingDataStore?
...
//    }
    ...
    private func navigateTo(source: UITVCalculatingViewController, destination: UIViewController) {
        //Navigation Forward
...
//    private func passDataTo(source: UITVCalculatingDataStore, destination: inout DestinationDataStore) {
//        destination.dataStore = source.dataStore
//    }
//
//    //Pass Data in Modal with Delegate
//    private func passDataTo(source: UITVCalculatingDataStore) {
